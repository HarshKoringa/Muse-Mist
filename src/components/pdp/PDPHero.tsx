...
export default function PDPHero({ product }: Props) {
  ...
  const images = getProductImages(product.slug, product.image_url ?? '')
    ...
    <>
      <section className="w-full">
        ...
        <div className="px-4 pt-4">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-[#1A237E]/60
                       hover:text-[#1A237E] transition-colors"
          >
            <ArrowLeft size={18} />
        ...
        <div className="max-w-6xl mx-auto px-4 py-6 lg:flex lg:gap-12 lg:items-start">

          {/* Gallery — left on desktop, full-width on mobile */}
          ...
          <div className="lg:w-1/2 mt-6 lg:mt-0">
            ...
            >
              ...
              {subtitle && (
                <p className="text-sm font-medium text-[#1A237E] opacity-50 mb-4">
                  {subtitle}
                </p>
              )}
              ...
              {/* How to use */}
              {product.how_to_use && (
                <div className="mb-8 p-4 rounded-xl bg-[#DCEFFF] border border-[#DCD9F8]">
